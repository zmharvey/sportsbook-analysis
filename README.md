# Sportsbook Analysis - Arbitrage and +EV Scanner
- Scans sportsbooks and checks for +EV plays (instances where some books lag behind sharper books, essentially giving good value to place the bet).
